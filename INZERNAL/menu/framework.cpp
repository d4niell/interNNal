...
void menu::framework_tab() {
    ...
    if (ImGui::Button("Unhook")) {
        utils::printc("91", "Unhooking... See you again!");
        utils::printc("92", "Terminating in 1 Second");
        Sleep(1000);
        global::unload = true;

    }
    ImGui::Checkbox("Disable Logging (improving gameplay/response time)", &logging::enabled);
    //utils::printc("92", "logging has been disabled by user");
}
